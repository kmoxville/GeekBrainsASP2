...
namespace PersonsWebApp.Controllers
{
    ...
    {
        private readonly IRepositoryService<PersonEntity, PersonDto> _personService;

        public PersonController(IRepositoryService<PersonEntity, PersonDto> personService)
        {
